...
class MissionCommander {
  ...
  const missionCommanderNode = new MissionCommander("Diana", "NodeJS")
  ...
  console.log(missionCommanderNode.getStudents) // changed to 100
  console.log(missionCommanderNode.getLives)// changed to 3